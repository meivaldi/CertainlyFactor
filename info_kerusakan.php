...
<body id="page-top">
          ...
          <div class="row">
            <div class="container">
              <div class="form-group">
                  ...
                  <select id="kerusakan" class="form-control" name="kerusakan">
                ...
                <div class="table-responsive" style="margin-top: 30px">
                  <table class="table">
                    <tr>
                      <td class="h5">Nama Kerusakan</td>
                      <td id="namaKerusakan"></td>
                    </tr>
                    <tr>
                      <td class="h5">Gejala</td>
                      <td id="gejala"></td>
                    </tr>
                    <tr>
                      <td class="h5">Solusi</td>
                      <td id="solusi"></td>
                    </tr>
                  </table>
                </div>
  ...
  <script type="text/javascript">
    $('#kerusakan').change(function() {
      ...
      $.ajax({
        type: "POST",
        url: "get_kerusakan.php",
        data: {kode: kode},
        success: function(data) {
          var output = JSON.parse(data)

          if (!output.error) {
            var namaKerusakan = output.nama_kerusakan
            var gejala = output.gejala
            var solusi = output.solusi

            $('#namaKerusakan').text(namaKerusakan)
            $('#gejala').text(gejala)
            $('#solusi').text(solusi)
          }
        }
