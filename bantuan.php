    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="container">
              <h3>Informasi Penggunaan Aplikasi</h3>

              <ol>
                <li style="font-size: 22px;">Login ke aplikasi.</li>
                <li style="font-size: 22px;">Masukkan data komputer yang ingin di diagnosa.</li>
                <li style="font-size: 22px;">Pilih Gejala Kerusakan.</li>
                <li style="font-size: 22px;">Tekan Tombol Diagnosa.</li>
                <li style="font-size: 22px;">Hasil diagnosa akan ditampilkan pada halaman berikutnya.</li>
              </ol>
            </div>
          </div>
