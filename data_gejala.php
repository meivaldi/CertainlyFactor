          ...
          <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalScrollableTitle">Tambah Data Gejala</h5>
              ...
              <div class="modal-body">
                <form method="POST">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kodeGejala" placeholder="Kode Gejala">
                  </div>
                  <div class="form-group">
                    <label for="namaGejala">Nama Gejala</label>
                    <input type="text" class="form-control" id="namaGejala" placeholder="Nama Gejala">
                  </div>
                  <div class="form-group">
                    <label for="nilaiGejala">Nilai</label>
                    <input type="text" class="form-control" id="nilaiGejala" placeholder="Nilai">
                  </div>
                </form>
              </div>
                    ...
                    <?php
                      ...
                      if ($hasil > 0) {
                        ...
                        while ($row = $query->fetch_array()) {
                          ...
                          echo '<td>'. $row['nilai_gejala'] .'</td>';
                          echo '<td>
                                  <span>
                                    <form method="POST" action="edit_data_gejala.php">
                                      <input type="hidden" name="kode" value="'.$row['kode_gejala'].'">
                                      <input type="hidden" name="nama" value="'.$row['nama_gejala'].'">
                                      <input type="hidden" name="nilai" value="'.$row['nilai_gejala'].'">
                                      <button type="submit" class="btn">
                                        <i class="fa fa-edit" style="color: #ffab00;"></i>
                                        </button>
                                    </form> 
                                    <form method="POST" action="hapus_data_gejala.php">
                                      <input type="hidden" name="kode" value="'.$row['kode_gejala'].'">
                                      <button type="submit" class="btn">
  ...
  <div class="modal fade" id="hapusData" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Hapus data gejala?</div>
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
  ...
  <script>
    $(document).ready(function() {
      $('#simpan').click(function() {
        var kode = $('#kodeGejala').val();
        var nama = $('#namaGejala').val();
        var nilai = $('#nilaiGejala').val();

        $.ajax({
          type: "POST",
          url: 'simpan_data_gejala.php',
          data: {kode: kode, nama: nama, nilai: nilai},
          beforeSend: function() {
          ...
          success: function(data) {
            if (data === 'ok') {
              ...
              window.location = 'data_gejala.php';
            } else {
