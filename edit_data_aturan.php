          ...
          <div class="row">
            <div class="container">
              <div class="modal-body">
                <form method="POST" action="edit_aturan_act.php">
                  <?php echo "<input type='hidden' name='id' value='$id'>" ?>
                  <div class="form-group">
                  <label for="kodeAturan">Kode Aturan</label>
                  <input type="text" class="form-control" id="kodeAturan" name="kode" value="<?php echo $kode; ?>">
                </div>
                <div class="form-group">
                  ...
                  <?php
                    ...
                    while ($row = $query->fetch_array()) {
                      echo "<div class='form-check' id='pilihGejala'>
                        <input class='form-check-input' type='radio' value=".$row['kode_gejala']." id=".$row['kode_gejala']." name='gejala'>
