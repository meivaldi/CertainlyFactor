          ...
          <div class="row">
            <div class="container">
              <div class="modal-body">
                <form method="POST" action="edit_gejala_act.php">
                  <div class="form-group">
                    <label for="kodeGejala">Kode Gejala</label>
                    <?php echo "<input type='text' class='form-control' name='kode' id='kodeGejala' value='$kode'>"?>
                  </div>
                  <div class="form-group">
                    <label for="namaGejala">Nama Gejala</label>
                    <?php echo "<input type='text' class='form-control' name='nama' id='namaGejala' value='$nama'>" ?>
                  </div>
                  <div class="form-group">
                    <label for="nilaiGejala">Nilai</label>
                    <?php echo "<input type='text' class='form-control' name='nilai' id='nilaiGejala' value='$nilai'>"?>
                  </div>
                  <button class="btn btn-default" style="margin-bottom: 25px; background: #ffab00; color: white;">Update Data</button>
                </form>
              </div>
            </div>
          </div>
