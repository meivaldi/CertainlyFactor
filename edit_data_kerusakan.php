              ...
              <div class="modal-body">
                <form method="POST" action="edit_act.php">
                  <div class="form-group">
                    ...
                    <?php echo "<input type='text' class='form-control' name='kode' id='kode' value='$kode'>"?>
                  </div>
                  <div class="form-group">
                    <label for="namaKerusakan">Nama Kerusakan</label>
                    <?php echo "<input type='text' class='form-control' name='nama' id='nama' value='$nama'>"?>
                  </div>
                  <div class="form-group">
                    <label for="solusi">Solusi</label>
                    <?php echo "<textarea class='form-control' name='solusi' id='solusi' rows='5'>$solusi</textarea>"?>
                  </div>
